...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _Delay2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */
...
struct _Delay2 final : public ::faust::dsp {
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _Delay2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp2 = int(std::min<float>(2.4e+05f, std::max<float>(0.0f, fRec3[0])));
			float fTemp3 = fVec0[(IOTA0 - iTemp2) & 262143];
			int iTemp4 = int(std::min<float>(2.4e+05f, std::max<float>(0.0f, fRec4[0])));
			fRec0[0] = fTemp3 + fRec2[0] * (fVec0[(IOTA0 - iTemp4) & 262143] - fTemp3);
			output0[i0] = FAUSTFLOAT(fRec0[0]);
			float fTemp5 = float(input1[i0]) + fSlow0 * fRec5[1];
			fVec1[IOTA0 & 262143] = fTemp5;
			float fTemp6 = fVec1[(IOTA0 - iTemp2) & 262143];
			fRec5[0] = fTemp6 + fRec2[0] * (fVec1[(IOTA0 - iTemp4) & 262143] - fTemp6);
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _Delay2 -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
