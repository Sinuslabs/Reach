...
#endif
namespace project {
struct FaustReverbMetaData {
		SN_NODE_ID("FaustReverb");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using FaustReverb = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _FaustReverb, FaustReverbMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
