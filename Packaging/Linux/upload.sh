...
zip -r "${NAME}-plugin.zip" "${NAME}.vst3" "${NAME}.component"
...
curl --progress-bar -k -u "${USERNAME}:${PASSWORD}" -T "${project_root}/build/${OS}/${NAME}-installer.pkg" "${UPLOAD_LOCATION}/builds/${NAME}/${VERSION}/${NAME}.pkg"
